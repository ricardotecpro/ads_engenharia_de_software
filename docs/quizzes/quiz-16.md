...
<ul>
  <li>1- Test Driven Development</li>
  <li>2- Red, Green, Refactor</li>
  <li>3- assert</li>
  <li>4- Arrange, Act, Assert</li>
  <li>5- Para melhorar a qualidade do código sem alterar seu comportamento (mantendo os testes passando)</li>
</ul>
</details>
