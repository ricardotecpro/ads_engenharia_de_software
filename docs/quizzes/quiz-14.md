...
<ul>
  <li>1- class Carro(Veiculo):</li>
  <li>2- A capacidade de objetos diferentes responderem ao mesmo método de formas diferentes</li>
  <li>3- Chamar métodos da classe pai (superclasse)</li>
  <li>4- __variavel (dois underlines)</li>
  <li>5- B é subclasse de A e herda atributos e métodos</li>
</ul>
</details>
